...
$check = FALSE;
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['phone']) && isset($_POST['check-in']) && isset($_POST['time']) && isset($_POST['guest']) ){
if(strlen($_POST['name'])<1 || strlen($_POST['email'])<1 || strlen($_POST['phone']) <1 || strlen($_POST['check-in']) <1 || strlen($_POST['time']) <1 || strlen($_POST['guest']) <1){
    ...
    return;
          ...
          return;
			...
			$checkin = htmlentities($_POST['check-in']);
			$time = htmlentities($_POST['time']);
			$type = htmlentities($_POST['guest']);
			$vkey = md5(time().$name);
			$email = htmlentities($_POST['email']);
			$sql = "INSERT INTO reservation (name,email,phone,checkIn,time,type,vkey) VALUES (:name,:email,:phone,:checkIn,:time,:type,:vkey)";
		  ...
		  if($stmt){
			...
			$body = "<a href = 'http://localhost/INTERN/verify.php?vkey=$vkey'> CLick to verify </a>";
			$headers = "From: sridharan.shooriya69@gmail.com \r\n";
				...
				<div class="col-sm-12 p-4 p-md-5 d-flex align-items-center justify-content-center bg-primary">
					...
					<?php
						...
						if(isset($_SESSION['error'])){
						  echo('<p style="color: black;">'.htmlentities($_SESSION['error'])."</p>\n");
						...
						<div class="row justify-content-center" id = "form">
							<div class="col-md-4">
								<div class="form-group">
									<input type="name" name = "name" class="form-control" id = "username" placeholder="Name">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
							...
							<div class="col-md-4">
								<div class="form-group">
									<div class="input-wrap">
										<div class="icon"><span class="fa fa-calendar" id = "caln"></span></div>
										<input type="text" class="form-control book_date" id = "checkin" placeholder="Check-In" name = "check-in">
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<div class="input-wrap">
										...
										<input type="text" class="form-control book_time" id = "btime" placeholder="Time" name = "time">
									</div>
								</div>
							</div>
							<div class="col-md-4">
							...
							<div class="col-md-4">
								<div class="form-group">
									<!--<input type="submit" onclick="return doValidate();" value="Book Your Table Now" class="btn btn-white py-3 px-4" >-->
